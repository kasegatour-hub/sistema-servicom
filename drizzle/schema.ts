...
export const shipments = mysqlTable("shipments", {
  ...
  serviceManualPriceCurrency: mysqlEnum("serviceManualPriceCurrency", ["EUR", "USD", "PEN"]).default("EUR"),
  apostilleManualPrice: decimal("apostilleManualPrice", { precision: 10, scale: 2 }),
  apostilleManualCurrency: mysqlEnum("apostilleManualCurrency", ["EUR", "USD", "PEN"]).default("EUR"),
  translationManualPrice: decimal("translationManualPrice", { precision: 10, scale: 2 }),
  translationManualCurrency: mysqlEnum("translationManualCurrency", ["EUR", "USD", "PEN"]).default("EUR"),
