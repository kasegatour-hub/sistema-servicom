...
const transferInput = z.object({
  ...
  recipientDocument: optionalText,
  ...
  if (!value.recipientBank && !value.recipientIban && !value.recipientCci) {
    ctx.addIssue({ code: "custom", path: ["recipientBank"], message: "Indica el banco, IBAN o CCI del destinatario." });
  }
});
