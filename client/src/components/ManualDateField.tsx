...
export function ManualDateField({ id, label, value, onChange, required = false, minYear = 1900, maxYear = new Date().getFullYear() + 25, error = "" }: { id: string; label: string; value: string; onChange: (value: string) => void; required?: boolean; minYear?: number; maxYear?: number; error?: string }) {
