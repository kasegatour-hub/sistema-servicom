...
const emptyForm: TransferForm = {
  senderName: "", senderPhone: "", senderDocument: "", senderDocumentType: "dni_peru", senderCity: "TORINO", senderPaymentMethod: "Agencia",
...
export function TransferWorkspace() {
  ...
  const submit = (event: React.FormEvent) => {
    ...
    create.mutate({ ...form, amountSent: Number(form.amountSent), transferFee, exchangeRate: Number(form.exchangeRate), destinationOffice: "Servicom Internacional — Lima", recipientBank: form.recipientBank || undefined, recipientIban: form.recipientIban || undefined, recipientCci: form.recipientCci || undefined });
  };
