...
export default function MobileAppPage() {
  ...
  const shipmentStatusUi = getShipmentStatusUi(shipment?.status);
  const authorizedUpdatePath = shipment ? `/admin?open=update&order=${encodeURIComponent(shipment.orderNumber)}&code=${encodeURIComponent(shipment.code)}&from=movil` : "/admin?from=movil";
