        ...
        <Card className="w-full max-w-md p-6 shadow-lg border-0">
          ...
          <form onSubmit={loginForm.handleSubmit(handleLogin)} className="space-y-4" autoComplete="off" hidden={adminAuthMode !== "login"}>
            <div>
              ...
              <p className="mt-2 text-xs text-slate-500">Master Admin: <strong>yeslygian2030@gmail.com</strong>. El correo institucional peruservicom@gmail.com no inicia sesión administrativa.</p>
            </div>
