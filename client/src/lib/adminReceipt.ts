...
export function buildAdminDeliveryTicketHtml(data: {
  ...
  const restrictionWarning = route.route === "Lima - Torino" && data.limaTorinoEncomiendasEnabled === false
    ...
    : "";
  const managementQrHtml = data.managementUrl
